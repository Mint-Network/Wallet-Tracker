 ...
 *
 * NOTE: Previously used swagger-jsdoc, but that pulls in glob -> lru-cache v11
 * which is incompatible with pkg's Node.js 18 runtime. Since apis was always [],
 * we export the spec object directly instead.
 */
const swaggerSpec = {
  openapi: "3.0.0",
  info: {
